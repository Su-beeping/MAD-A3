...
export default function EditItemScreen({ navigation, route }) {
  ...
  const [categoryId, setCategoryId] = useState(item.category_id ? item.category_id.toString() : '');
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TouchableOpacity style={styles.saveBtn} onPress={updateItem}>
        <Text style={styles.saveTxt}>Update Item</Text>
      </TouchableOpacity>
